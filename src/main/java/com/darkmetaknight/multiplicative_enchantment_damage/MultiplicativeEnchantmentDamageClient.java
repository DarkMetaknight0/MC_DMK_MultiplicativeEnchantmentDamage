...
public class MultiplicativeEnchantmentDamageClient {
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        ...
        MultiplicativeEnchantmentDamage.LOGGER.info("HELLO FROM CLIENT SETUP");
        MultiplicativeEnchantmentDamage.LOGGER.info("MINECRAFT NAME >> {}", Minecraft.getInstance().getUser().getName());
    }
}
